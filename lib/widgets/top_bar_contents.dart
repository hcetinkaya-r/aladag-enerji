...
import 'package:aladag_enerji/utils/auth.dart';
import 'package:aladag_enerji/utils/routes_name.dart';
import 'package:aladag_enerji/widgets/auth_dialog.dart';
                ...
                ? Container(
                    ...
                    decoration: BoxDecoration(
                      image: DecorationImage(
                        fit: BoxFit.cover,
                        image: AssetImage(
                            '/Users/hakancetinkaya/AndroidStudioProjects/aladag_enerji/assets/images/hsc-solar-logo.png'),
                      ),
              ...
              child: Row(
                children: <Widget>[
                  InkWell(
                    ...
                    onTap: () => widget.onTap('${widget.contents[0]}'),
                    child: Column(
                  ...
                  InkWell(
                    ...
                    onTap: () => widget.onTap('${widget.contents[1]}'),
                    child: Column(
                      mainAxisSize: MainAxisSize.min,
                      children: [
                        Text(
                  ...
                  InkWell(
                    ...
                    onTap: () => widget.onTap('${widget.contents[2]}'),
                    child: Column(
                      mainAxisSize: MainAxisSize.min,
                      children: [
                        Text(
                  ...
                  InkWell(
                    ...
                    onTap: () => widget.onTap('${widget.contents[3]}'),
                    child: Column(
                      mainAxisSize: MainAxisSize.min,
                      children: [
                        Text(
